...
export function ResultSummary({ result }: ResultSummaryProps) {
  ...
  return (
    <section
      className="mx-auto grid w-full max-w-7xl gap-5 px-4 py-8"
      aria-label="Prediction result"
    >
      <div className="overflow-hidden border-2 border-[#d91f1f] bg-white text-xs text-foreground shadow-[0_16px_42px_rgba(17,24,39,0.08)] sm:text-sm">
