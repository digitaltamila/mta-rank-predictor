  ...
  return (
    ...
    >
      <div className="mb-5 border-b border-border pb-4">
        ...
        {comingSoonTab && (
          <div className="mb-4 flex items-center gap-3 rounded-md border border-yellow bg-yellow/20 px-3 py-2 text-sm font-bold text-navy">
            <Loader2 className="animate-spin" aria-hidden size={17} />
            {comingSoonTab.toUpperCase()} calculator is coming soon.
          </div>
        )}
        <p className="text-sm font-bold uppercase text-navy">
          RRB NTPC CBT-I Graduate Level 2025-26
        </p>
      ...
      <div className="grid gap-4">
        <label className="grid gap-2" htmlFor="response-sheet-url">
          ...
          <Input
            ...
            aria-describedby={
              fieldError || errorMessage ? 'prediction-form-message' : undefined
            }
      ...
      {(fieldError || errors.category?.message || consentError || errorMessage) && (
        <p
